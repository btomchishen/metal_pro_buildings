...
?><div id="<?=htmlspecialcharsbx($containerId)?>" class="crm-entity-wrap"><?
	...
	?><div class="<?=$tabContainerClassName?>" data-role="crm-item-detail-container">
        ...
        if($arResult['ENTITY_INFO']['ENTITY_TYPE_NAME'] == 'LEAD')
            $arResult['REST_USE'] = true;

		?></ul>
        <!--Avivi: add custon links previous/next-->
        <?if($arResult['ENTITY_INFO']['ENTITY_TYPE_NAME'] == 'LEAD' || //LEAD
             $arResult['ENTITY_INFO']['ENTITY_TYPE_NAME'] == 'DEAL' || //DEAL
             $arResult['ENTITY_INFO']['ENTITY_TYPE_NAME'] == 'CONTACT'): //CONTACT?>
            <div class="custom-links-previous-next">
                <a href="<?=$arResult['CUSTOM_LINK_PREVIOUS']?>">
                    <span class="crm-entity-section-tab-link link-previous-crm-entity">Previous</span>
                </a>
                <a href="<?=$arResult['CUSTOM_LINK_NEXT']?>">
                    <span class="crm-entity-section-tab-link link-next-crm-entity">Next</span>
                </a>
            </div>
        <?endif;?>
        <!--Avivi: END_add custon links previous/next-->
    </div>
